...
var UserController = /** @class */ (function () {
    ...
    UserController.getById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, userRepository, user, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
    ...
    UserController.newUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, role, user, errors, userRepository, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    user.role = role;
                    return [4 /*yield*/, class_validator_1.validate(user, { validationError: { target: false, value: false } })];
                case 1:
                    errors = _b.sent();
                    if (errors.length > 0) {
    ...
    UserController.editUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, user, _a, username, role, userRepository, error_4, validationSub, errors, error_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
                ...
                case 4:
                    ...
                    return [4 /*yield*/, class_validator_1.validate(user, validationSub)];
                case 5:
                    errors = _b.sent();
                    if (errors.length > 0) {
                        return [2 /*return*/, res.status(400).json(errors)];
    ...
    UserController.deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, userRepository, user, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
